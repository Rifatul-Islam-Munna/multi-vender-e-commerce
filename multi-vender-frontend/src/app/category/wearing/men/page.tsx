...
import { bestSellerProducts, customerFavoriteProducts, newArrivalsProducts, trendingProducts, weeklyDealsProducts } from "@/Static-Data/wearing-common/products"
  ...
  return (
    <main className="min-h-screen">
      ...
      <WeeklyDeals
        ...
        onAddToCart={(id) => console.log(`Added ${id} to cart from weekly deals`)}
      />

      <ShopByCategory categories={categories} />

      <TrendingNow products={trendingProducts} onAddToCart={(id) => console.log(`Added ${id} to cart from trending`)} />

      <NewArrivals
        products={newArrivalsProducts}
        onAddToCart={(id) => console.log(`Added ${id} to cart from new arrivals`)}
      />

      <BestSellers
        products={bestSellerProducts}
        onAddToCart={(id) => console.log(`Added ${id} to cart from best sellers`)}
      />
      ...
      <SeasonalPicks
        ...
        onAddToCart={(id) => console.log(`Added ${id} to cart from seasonal picks`)}
      />
      ...
      <CustomerFavorites
        ...
        onAddToCart={(id) => console.log(`Added ${id} to cart from customer favorites`)}
      />
